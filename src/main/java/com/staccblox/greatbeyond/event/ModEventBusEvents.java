package com.staccblox.greatbeyond.event;

import com.staccblox.greatbeyond.GreatBeyond;
import com.staccblox.greatbeyond.entity.ModEntities;
import com.staccblox.greatbeyond.entity.client.GeckoModel;
import com.staccblox.greatbeyond.entity.client.TomahawkProjectileModel;
...
@EventBusSubscriber(modid = GreatBeyond.MOD_ID, bus = EventBusSubscriber.Bus.MOD)
