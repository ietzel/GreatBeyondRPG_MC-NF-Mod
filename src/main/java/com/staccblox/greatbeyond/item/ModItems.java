package com.staccblox.greatbeyond.item;
...
import com.staccblox.greatbeyond.item.custom.*;
import com.staccblox.greatbeyond.item.custom.*;
...
public class ModItems {
    public static final DeferredRegister.Items ITEMS = DeferredRegister.createItems(GreatBeyond.MOD_ID);
    ...
    public static final DeferredItem<Item> KAUPEN_SMITHING_TEMPLATE = ITEMS.register("kaupen_armor_trim_smithing_template",
            () -> SmithingTemplateItem.createArmorTrimTemplate(ResourceLocation.fromNamespaceAndPath(GreatBeyond.MOD_ID, "kaupen")));
