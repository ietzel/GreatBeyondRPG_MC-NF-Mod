package com.staccblox.greatbeyond.entity;

import com.staccblox.greatbeyond.GreatBeyond;
import com.staccblox.greatbeyond.entity.custom.ChairEntity;
import com.staccblox.greatbeyond.entity.custom.GeckoEntity;
import com.staccblox.greatbeyond.entity.custom.TomahawkProjectileEntity;
...
public class ModEntities {
    public static final DeferredRegister<EntityType<?>> ENTITY_TYPES =
            DeferredRegister.create(BuiltInRegistries.ENTITY_TYPE, GreatBeyond.MOD_ID);
